...
$lang = array_merge($lang, array(
	...
	'STATUS'					=> 'الحالة',
	'AD_NAME'					=> 'الاسم',
	'AD_NAME_EXPLAIN'			=> 'الاسم يساعدك على تحديد الإعلان فحسب.',
	'AD_ENABLED'				=> 'مفعّل',
	'AD_ENABLED_EXPLAIN'		=> 'إذا تعطل، لن يظهر هذا الإعلان.',
	'AD_NOTE'					=> 'ملاحظات',
	...
	'ANALYSE_AD_CODE'			=> 'فحص الكود الإعلاني',
	'EVERYTHING_OK'				=> 'الكود يظهر جيد.',
	'AD_BANNER'					=> 'بنر إشهاري',
	'BANNER'					=> 'رفع بنر إشهاري',
	'BANNER_EXPLAIN'			=> 'يمكنك رفع الصورة بصيغة JPG, GIF أو PNG. الصور يتم حفظها في مجلد النظام <samp>images</samp> ووسم الصورة HTML سيُدرج آليا في خانة الكود.',
	'BANNER_UPLOAD'				=> 'رفع بنر',
	...
	'AD_VIEWS'					=> 'مشاهدات',
	'AD_VIEWS_LIMIT'			=> 'تحديد المشاهدات',
	...
	'AD_PREVIEW'				=> 'استعراض هذا الإعلان',
